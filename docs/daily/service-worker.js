const CACHE_NAME = "n3-vocab-cards-daily-v5";
const ASSETS = ["./", "./index.html", "./manifest.json", "./daily-cards.json", "./day-1.json", "./day-2.json", "./day-3.json", "./day-4.json", "./day-5.json", "./day-6.json", "./day-7.json", "./day-8.json", "./day-9.json", "./day-10.json", "./day-11.json", "./day-12.json"];
